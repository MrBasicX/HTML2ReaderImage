...
// Array of valid HTML color names
...
function isValidColor(color) {
    // Check if color is a valid hexadecimal color or a valid HTML color name
    return color && (validator_1.default.isHexColor(color) || htmlColorNames.has(color.toLowerCase()));
}
exports.isValidColor = isValidColor;
//# sourceMappingURL=colorMatch.js.map